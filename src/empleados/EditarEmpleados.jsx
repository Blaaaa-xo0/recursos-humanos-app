...
export default function EditarEmpleados() {
    ...
    const onSubmit = async (e) => {
        ...
        e.preventDefault()
        await axios.put(`${urlBase}/update/${id}`, empleado);
    ...
    return (
        <div className='container mx-auto max-w-5xl py-12'>
            ...
            <div className='flex justify-center items-center'>
                <h3 className='text-xl md:text-3xl py-6'>Editar Empleado</h3>
            </div>
            ...
            <form className="mx-auto" onSubmit={(e) => onSubmit(e)}>
                ...
                <button type="submit" className='text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2'>Guardar Empleado</button>
